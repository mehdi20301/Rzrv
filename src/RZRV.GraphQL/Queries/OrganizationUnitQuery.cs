...
using RZRV.Core.Base;
using RZRV.Core.Extensions;
using RZRV.Dto;
using RZRV.Types;

namespace RZRV.Queries
{
    public class OrganizationUnitQuery : RZRVQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
