...
{
    public class SubscriptionPaymentExtensionDataRepository : RZRVRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<RZRVDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
