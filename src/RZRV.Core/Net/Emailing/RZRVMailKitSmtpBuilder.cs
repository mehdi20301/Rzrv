...
{
    public class RZRVMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public RZRVMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(RZRVConsts.LocalizationSourceName, name);
        }
    }
}