...
using RZRV.Mobile.MAUI.Services.Tenants;

#if ANDROID
using RZRV.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace RZRV.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new RZRV.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
