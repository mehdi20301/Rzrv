...
namespace RZRV.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : RZRVServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours).ToString(RZRVConsts.DateTimeOffsetFormat));
