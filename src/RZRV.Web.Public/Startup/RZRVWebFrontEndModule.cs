...
{
    [DependsOn(
        typeof(RZRVWebCoreModule)
    )]
    public class RZRVWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public RZRVWebFrontEndModule(IWebHostEnvironment env, RZRVEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RZRVWebFrontEndModule).GetAssembly());
        }
    }
}
