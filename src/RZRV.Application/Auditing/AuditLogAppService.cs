...
using RZRV.Auditing.Exporting;
using RZRV.Authorization;
using RZRV.Authorization.Users;
using RZRV.Dto;
using RZRV.EntityHistory;
using EntityHistoryHelper = RZRV.EntityHistory.EntityHistoryHelper;

namespace RZRV.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : RZRVAppServiceBase, IAuditLogAppService
    {
