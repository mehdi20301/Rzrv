...
using RZRV.Authorization.Ldap;
using RZRV.Authorization.Roles;
using RZRV.Authorization.Users;
using RZRV.Chat;
using RZRV.Configuration;
using RZRV.DashboardCustomization.Definitions;
using RZRV.Debugging;
using RZRV.DynamicEntityProperties;
using RZRV.Features;
using RZRV.Friendships;
using RZRV.Friendships.Cache;
using RZRV.Localization;
using RZRV.MultiTenancy;
using RZRV.Net.Emailing;
using RZRV.Notifications;
using RZRV.WebHooks;
...
{
    [DependsOn(
        typeof(RZRVCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class RZRVCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            RZRVLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = RZRVConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, RZRVMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<RZRVSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RZRVCoreModule).GetAssembly());
        }
