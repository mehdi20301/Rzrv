...
using RZRV.Auditing;
using RZRV.Authorization.Users.Password;
using RZRV.Configuration;
using RZRV.EntityFrameworkCore;
using RZRV.MultiTenancy;
using RZRV.Web.Startup.ExternalLoginInfoProviders;
...
namespace RZRV.Web.Startup
{
    ...
    public class RZRVWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public RZRVWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RZRVWebHostModule).GetAssembly());
        }
