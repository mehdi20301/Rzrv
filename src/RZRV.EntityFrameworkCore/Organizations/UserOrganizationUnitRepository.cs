...
using RZRV.EntityFrameworkCore.Repositories;

namespace RZRV.Organizations
{
    public class UserOrganizationUnitRepository : RZRVRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<RZRVDbContext> dbContextProvider)
