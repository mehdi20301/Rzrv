...
{
    public class SessionAppService : RZRVAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = RZRVConsts.Currency,
                        CurrencySign = RZRVConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = RZRVConsts.AllowTenantsToChangeEmailSettings,
