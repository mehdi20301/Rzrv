...
{
    public class RZRVDbContext : AbpZeroDbContext<Tenant, Role, User, RZRVDbContext>
    {
        ...
        public RZRVDbContext(DbContextOptions<RZRVDbContext> options)
            : base(options)
        {
