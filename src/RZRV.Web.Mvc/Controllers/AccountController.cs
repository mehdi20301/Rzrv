...
using RZRV.Authentication.TwoFactor.Google;
using RZRV.Authorization;
using RZRV.Authorization.Accounts;
using RZRV.Authorization.Accounts.Dto;
using RZRV.Authorization.Delegation;
using RZRV.Authorization.Impersonation;
...
using RZRV.Web.Models.Account;
using RZRV.Security;
using RZRV.Security.Recaptcha;
using RZRV.Sessions;
using RZRV.Url;
using RZRV.Web.Authentication.External;
using RZRV.Web.Security.Recaptcha;
using RZRV.Web.Session;
using RZRV.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : RZRVControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(RZRVConsts.DateTimeOffsetFormat));
        ...
        #region Easy Login / Register
        //[HttpPost]
        //public ActionResult EasyLogin(string provider, string returnUrl)
        //{
