...
using RZRV.Organizations;
using RZRV.Web.Areas.App.Models.Notifications;
using RZRV.Web.Areas.App.Models.OrganizationUnits;
...
namespace RZRV.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class NotificationsController : RZRVControllerBase
    {
