...
namespace RZRV.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : RZRVServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("RZRV", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
