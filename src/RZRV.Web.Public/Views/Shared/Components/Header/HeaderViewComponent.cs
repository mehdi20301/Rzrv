...
using RZRV.Url;
using RZRV.Web.Public.Startup;
using RZRV.Web.Session;
using RZRV.Web.UiCustomization;

namespace RZRV.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : RZRVViewComponent
    {
