...
using RZRV.Authentication.TwoFactor;
using RZRV.Chat;
using RZRV.Configuration;
using RZRV.EntityFrameworkCore;
using RZRV.Startup;
using RZRV.Web.Authentication.JwtBearer;
using RZRV.Web.Authentication.TwoFactor;
using RZRV.Web.Chat.SignalR;
using RZRV.Web.Common;
using RZRV.Web.Configuration;
using RZRV.Web.DashboardCustomization;
...
{
    [DependsOn(
        typeof(RZRVApplicationModule),
        typeof(RZRVEntityFrameworkCoreModule),
    ...
    public class RZRVWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public RZRVWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(RZRVApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RZRVWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(RZRVWebCoreModule).Assembly);
        }
