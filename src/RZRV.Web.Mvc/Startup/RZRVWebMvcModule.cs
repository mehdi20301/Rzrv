...
namespace RZRV.Web.Startup
{
    ...
    public class RZRVWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public RZRVWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RZRVWebMvcModule).GetAssembly());
        }
